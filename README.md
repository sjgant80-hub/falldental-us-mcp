...
MCP stdio server wrapping `@ai-native-solutions/falldental-us-sdk`.

## Install
```bash
claude mcp add falldental-us -- npx -y @ai-native-solutions/falldental-us-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/falldental-us-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falldental-us-mcp -- npx -y @ai-native-solutions/falldental-us-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falldental-us-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-mcp
- **Live URL**: https://sjgant80-hub.github.io/falldental-us-mcp/
- **Source**: https://github.com/sjgant80-hub/falldental-us-mcp
